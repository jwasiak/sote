...
/** 
 * Subclass for performing query and update operations on the 'st_product_has_attribute_field' table.
 *
 * @package     stAttributeTemplatePlugin
 * @subpackage  libs
 */
class ProductHasAttributeFieldPeer extends BaseProductHasAttributeFieldPeer
{
}
