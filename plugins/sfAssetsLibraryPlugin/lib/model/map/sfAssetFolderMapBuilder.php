...
class sfAssetFolderMapBuilder {
    ...
    public function doBuild()
    {
        ...
        $tMap->addForeignKey('TREE_PARENT', 'TreeParent', 'int', CreoleTypes::INTEGER, 'sf_asset_folder', 'ID', false, null);

        $tMap->addColumn('TREE_DEPTH', 'TreeDepth', 'int', CreoleTypes::INTEGER, false, null);
