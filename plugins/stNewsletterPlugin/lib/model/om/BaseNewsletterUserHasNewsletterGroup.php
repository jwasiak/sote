...
/**
 * Base class that represents a row from the 'st_newsletter_user_has_newsletter_group' table.
 *
 * 
 *
...
abstract class BaseNewsletterUserHasNewsletterGroup extends BaseObject  implements Persistent {
	 ...
	 * @var        NewsletterUserHasNewsletterGroupPeer
	 */
	...
	/**
	 * The value for the newsletter_user_id field.
	 * @var        int
	 */
    ...
    /**
     * Get the [newsletter_user_id] column value.
     * 
     * @return     int
     */
	...
	/**
	 * Set the value of [newsletter_user_id] column.
	 * 
	 * @param      int $v new value
	 * @return     void
	 */
  ...
  {
    try {
      if ($this->getDispatcher()->getListeners('NewsletterUserHasNewsletterGroup.preHydrate')) {
          $event = $this->getDispatcher()->notify(new sfEvent($this, 'NewsletterUserHasNewsletterGroup.preHydrate', array('resultset' => $rs, 'startcol' => $startcol)));
      ...
      $this->setNew(false);
      if ($this->getDispatcher()->getListeners('NewsletterUserHasNewsletterGroup.postHydrate')) {
          $event = $this->getDispatcher()->notify(new sfEvent($this, 'NewsletterUserHasNewsletterGroup.postHydrate', array('resultset' => $rs, 'startcol' => $startcol + 5)));
          return $event['startcol'];
      }

      // FIXME - using NUM_COLUMNS may be clearer.
      return $startcol + 5; // 5 = NewsletterUserHasNewsletterGroupPeer::NUM_COLUMNS - NewsletterUserHasNewsletterGroupPeer::NUM_LAZY_LOAD_COLUMNS).
  ...
  public function delete($con = null)
  {
    ...
    if ($this->getDispatcher()->getListeners('NewsletterUserHasNewsletterGroup.preDelete')) {
        $this->getDispatcher()->notify(new sfEvent($this, 'NewsletterUserHasNewsletterGroup.preDelete', array('con' => $con)));
    }

    if (sfMixer::hasCallables('BaseNewsletterUserHasNewsletterGroup:delete:pre'))
    {
    ...
    if ($this->getDispatcher()->getListeners('NewsletterUserHasNewsletterGroup.postDelete')) {
        $this->getDispatcher()->notify(new sfEvent($this, 'NewsletterUserHasNewsletterGroup.postDelete', array('con' => $con)));
    }

    if (sfMixer::hasCallables('BaseNewsletterUserHasNewsletterGroup:delete:post'))
    {
  ...
  public function save($con = null)
  {
    ...
    if (!$this->alreadyInSave) {
      if ($this->getDispatcher()->getListeners('NewsletterUserHasNewsletterGroup.preSave')) {
    ...
    try {
      ...
      if (!$this->alreadyInSave) {
        if ($this->getDispatcher()->getListeners('NewsletterUserHasNewsletterGroup.postSave')) {
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of NewsletterUserHasNewsletterGroup (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     NewsletterUserHasNewsletterGroup Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     NewsletterUserHasNewsletterGroupPeer
	 */
	...
	/**
	 * Declares an association between this object and a NewsletterUser object.
	 *
	 * @param      NewsletterUser $v
	 * @return     void
	 * @throws     PropelException
	 */
	...
	/**
	 * Get the associated NewsletterUser object
	 *
	 * @param      Connection Optional Connection object.
	 * @return     NewsletterUser The associated NewsletterUser object.
	 * @throws     PropelException
	 */
	public function getNewsletterUser($con = null)
	{
		if ($this->aNewsletterUser === null && ($this->newsletter_user_id !== null)) {
			...
			/* The following can be used instead of the line above to
			   ...
			   As it can lead to a db query with many results that may
			   never be used.
			   $obj = NewsletterUserPeer::retrieveByPK($this->newsletter_user_id, $con);
			   $obj->addNewsletterUsers($this);
			 */
		}
...
} // BaseNewsletterUserHasNewsletterGroup
