 ...
 * @version     $Id: WebpageHasPositioning.php 10204 2011-01-13 11:06:34Z michal $
 * @author      Michal Prochowski <michal.prochowski@sote.pl>
 */

/**
 * Klasa WebpageHasPositioning
 *
 * @package     stPositioningPlugin
 * @subpackage  libs
 * @author      Michal Prochowski <michal.prochowski@sote.pl>
 */
class WebpageHasPositioning extends BaseWebpageHasPositioning
{
    /**
    ...
    public function setWebpageUrl($v)
    {
        $this->getWebpage()->setUrl($v);
    }
}