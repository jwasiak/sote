 ...
 * @version     $Id: ProductGroupHasPositioning.php 10204 2011-01-13 11:06:34Z michal $
 * @author      Michal Prochowski <michal.prochowski@sote.pl>
 */

/**
 * Klasa ProductGroupHasPositioning
 *
 * @package     stPositioningPlugin
 * @subpackage  libs
 * @author      Michal Prochowski <michal.prochowski@sote.pl>
 */
class ProductGroupHasPositioning extends BaseProductGroupHasPositioning
{
    /**
    ...
    public function setProductGroupUrl($v)
    {
        $this->getProductGroup()->setUrl($v);
    }
}