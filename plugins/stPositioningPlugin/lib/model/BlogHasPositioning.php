 ...
 * @version     $Id: BlogHasPositioning.php 10204 2011-01-13 11:06:34Z pawel $
 * @author      Pawel Byszewski <pawel.byszewski@sote.pl>
 */

/**
 * Klasa BlogHasPositioning
 *
 * @package     stPositioningPlugin
 * @subpackage  libs
 * @author      Pawel Byszewski <pawel.byszewski@sote.pl>
 */
class BlogHasPositioning extends BaseBlogHasPositioning
{
    /**
    ...
    public function setBlogUrl($v)
    {
        $this->getBlog()->setUrl($v);
    }
}