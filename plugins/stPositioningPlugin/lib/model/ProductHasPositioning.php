 ...
 * @version     $Id: ProductHasPositioning.php 10204 2011-01-13 11:06:34Z michal $
 * @author      Michal Prochowski <michal.prochowski@sote.pl>
 */

/**
 * Klasa ProductHasPositioning
 *
 * @package     stPositioningPlugin
 * @subpackage  libs
 * @author      Michal Prochowski <michal.prochowski@sote.pl>
 */
class ProductHasPositioning extends BaseProductHasPositioning
{
    /**
    ...
    public function setProductUrl($v)
    {
        $this->getProduct()->setUrl($v);
    }
