...
/**
 * Base class that represents a row from the 'st_product_group_has_positioning_i18n' table.
 *
 * 
 *
...
abstract class BaseProductGroupHasPositioningI18n extends BaseObject  implements Persistent {
	 ...
	 * @var        ProductGroupHasPositioningI18nPeer
	 */
	...
	/**
	 * @var        ProductGroupHasPositioning
	 */
  ...
  {
    try {
      if ($this->getDispatcher()->getListeners('ProductGroupHasPositioningI18n.preHydrate')) {
          $event = $this->getDispatcher()->notify(new sfEvent($this, 'ProductGroupHasPositioningI18n.preHydrate', array('resultset' => $rs, 'startcol' => $startcol)));
      ...
      $this->setNew(false);
      if ($this->getDispatcher()->getListeners('ProductGroupHasPositioningI18n.postHydrate')) {
          $event = $this->getDispatcher()->notify(new sfEvent($this, 'ProductGroupHasPositioningI18n.postHydrate', array('resultset' => $rs, 'startcol' => $startcol + 6)));
          return $event['startcol'];
      }

      // FIXME - using NUM_COLUMNS may be clearer.
      return $startcol + 6; // 6 = ProductGroupHasPositioningI18nPeer::NUM_COLUMNS - ProductGroupHasPositioningI18nPeer::NUM_LAZY_LOAD_COLUMNS).
  ...
  public function delete($con = null)
  {
    ...
    if ($this->getDispatcher()->getListeners('ProductGroupHasPositioningI18n.preDelete')) {
        $this->getDispatcher()->notify(new sfEvent($this, 'ProductGroupHasPositioningI18n.preDelete', array('con' => $con)));
    }

    if (sfMixer::hasCallables('BaseProductGroupHasPositioningI18n:delete:pre'))
    {
    ...
    if ($this->getDispatcher()->getListeners('ProductGroupHasPositioningI18n.postDelete')) {
        $this->getDispatcher()->notify(new sfEvent($this, 'ProductGroupHasPositioningI18n.postDelete', array('con' => $con)));
    }

    if (sfMixer::hasCallables('BaseProductGroupHasPositioningI18n:delete:post'))
    {
  ...
  public function save($con = null)
  {
    ...
    if (!$this->alreadyInSave) {
      if ($this->getDispatcher()->getListeners('ProductGroupHasPositioningI18n.preSave')) {
    ...
    try {
      ...
      if (!$this->alreadyInSave) {
        if ($this->getDispatcher()->getListeners('ProductGroupHasPositioningI18n.postSave')) {
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ProductGroupHasPositioningI18n (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ProductGroupHasPositioningI18n Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ProductGroupHasPositioningI18nPeer
	 */
	...
	/**
	 * Declares an association between this object and a ProductGroupHasPositioning object.
	 *
	 * @param      ProductGroupHasPositioning $v
	 * @return     void
	 * @throws     PropelException
	 */
	...
	/**
	 * Get the associated ProductGroupHasPositioning object
	 *
	 * @param      Connection Optional Connection object.
	 * @return     ProductGroupHasPositioning The associated ProductGroupHasPositioning object.
	 * @throws     PropelException
	 */
	public function getProductGroupHasPositioning($con = null)
	{
		if ($this->aProductGroupHasPositioning === null && ($this->id !== null)) {
			...
			/* The following can be used instead of the line above to
			   ...
			   never be used.
			   $obj = ProductGroupHasPositioningPeer::retrieveByPK($this->id, $con);
			   $obj->addProductGroupHasPositionings($this);
			 */
		}
...
} // BaseProductGroupHasPositioningI18n
