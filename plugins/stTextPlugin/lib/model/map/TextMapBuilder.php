...
/**
 * This class adds structure of 'st_text' table to 'propel' DatabaseMap object.
 *
 *
 *
...
class TextMapBuilder {
     ...
     */
    const CLASS_NAME = 'plugins.stTextPlugin.lib.model.map.TextMapBuilder';
    ...
    public function doBuild()
    {
        ...
        $tMap = $this->dbMap->addTable('st_text');
        $tMap->setPhpName('Text');
