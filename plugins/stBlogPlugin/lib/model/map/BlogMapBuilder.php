...
/**
 * This class adds structure of 'st_blog' table to 'propel' DatabaseMap object.
 *
 *
 *
...
class BlogMapBuilder {
     ...
     */
    const CLASS_NAME = 'plugins.stBlogPlugin.lib.model.map.BlogMapBuilder';
    ...
    public function doBuild()
    {
        ...
        $tMap = $this->dbMap->addTable('st_blog');
        ...
        $tMap->addColumn('OPT_LONG_DESCRIPTION', 'OptLongDescription', 'string', CreoleTypes::LONGVARCHAR, false, null);

        $tMap->addColumn('IMAGE_MAIN_PAGE', 'ImageMainPage', 'string', CreoleTypes::VARCHAR, false, 255);
        ...
        $tMap->addColumn('ALTERNATIVE_URL', 'AlternativeUrl', 'string', CreoleTypes::VARCHAR, false, 255);

        $tMap->addColumn('GALLERY', 'Gallery', 'array', CreoleTypes::VARCHAR, false, 4096);
