...
/**
 * Base class that represents a row from the 'st_countries_area_has_countries' table.
 *
 * 
 *
...
abstract class BaseCountriesAreaHasCountries extends BaseObject  implements Persistent {
	 ...
	 * @var        CountriesAreaHasCountriesPeer
	 */
  ...
  {
    try {
      if ($this->getDispatcher()->getListeners('CountriesAreaHasCountries.preHydrate')) {
          $event = $this->getDispatcher()->notify(new sfEvent($this, 'CountriesAreaHasCountries.preHydrate', array('resultset' => $rs, 'startcol' => $startcol)));
      ...
      $this->setNew(false);
      if ($this->getDispatcher()->getListeners('CountriesAreaHasCountries.postHydrate')) {
          $event = $this->getDispatcher()->notify(new sfEvent($this, 'CountriesAreaHasCountries.postHydrate', array('resultset' => $rs, 'startcol' => $startcol + 5)));
          return $event['startcol'];
      }

      // FIXME - using NUM_COLUMNS may be clearer.
      return $startcol + 5; // 5 = CountriesAreaHasCountriesPeer::NUM_COLUMNS - CountriesAreaHasCountriesPeer::NUM_LAZY_LOAD_COLUMNS).
  ...
  public function delete($con = null)
  {
    ...
    if ($this->getDispatcher()->getListeners('CountriesAreaHasCountries.preDelete')) {
        $this->getDispatcher()->notify(new sfEvent($this, 'CountriesAreaHasCountries.preDelete', array('con' => $con)));
    }

    if (sfMixer::hasCallables('BaseCountriesAreaHasCountries:delete:pre'))
    {
    ...
    if ($this->getDispatcher()->getListeners('CountriesAreaHasCountries.postDelete')) {
        $this->getDispatcher()->notify(new sfEvent($this, 'CountriesAreaHasCountries.postDelete', array('con' => $con)));
    }

    if (sfMixer::hasCallables('BaseCountriesAreaHasCountries:delete:post'))
    {
  ...
  public function save($con = null)
  {
    ...
    if (!$this->alreadyInSave) {
      if ($this->getDispatcher()->getListeners('CountriesAreaHasCountries.preSave')) {
    ...
    try {
      ...
      if (!$this->alreadyInSave) {
        if ($this->getDispatcher()->getListeners('CountriesAreaHasCountries.postSave')) {
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of CountriesAreaHasCountries (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     CountriesAreaHasCountries Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     CountriesAreaHasCountriesPeer
	 */
