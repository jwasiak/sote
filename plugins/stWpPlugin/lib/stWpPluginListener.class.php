 ...
 * @version     $Id: stWpPluginListener.class.php 10 2009-08-24 09:32:18Z michal $
...
class stWpPluginListener
{
    ...
    public static function generate(sfEvent $event)
    {
        ...
        $event->getSubject()->attachAdminGeneratorFile('stWpPlugin', 'stWpInProduct.yml');
    }
}