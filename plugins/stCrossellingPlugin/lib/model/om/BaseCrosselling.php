...
/**
 * Base class that represents a row from the 'st_crosselling' table.
 *
 * 
 *
...
abstract class BaseCrosselling extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the first_product_id field.
	 * @var        int
	 */
	...
	/**
	 * The value for the secound_product_id field.
	 * @var        int
	 */
    ...
    /**
     * Get the [first_product_id] column value.
     * 
     * @return     int
     */
    ...
    /**
     * Get the [secound_product_id] column value.
     * 
     * @return     int
     */
	...
	/**
	 * Set the value of [first_product_id] column.
	 * 
	 * @param      int $v new value
	 * @return     void
	 */
	...
	/**
	 * Set the value of [secound_product_id] column.
	 * 
	 * @param      int $v new value
	 * @return     void
	 */
  ...
  {
    try {
      if ($this->getDispatcher()->getListeners('Crosselling.preHydrate')) {
          $event = $this->getDispatcher()->notify(new sfEvent($this, 'Crosselling.preHydrate', array('resultset' => $rs, 'startcol' => $startcol)));
      ...
      $this->setNew(false);
      if ($this->getDispatcher()->getListeners('Crosselling.postHydrate')) {
          $event = $this->getDispatcher()->notify(new sfEvent($this, 'Crosselling.postHydrate', array('resultset' => $rs, 'startcol' => $startcol + 6)));
          return $event['startcol'];
      }

      // FIXME - using NUM_COLUMNS may be clearer.
      return $startcol + 6; // 6 = CrossellingPeer::NUM_COLUMNS - CrossellingPeer::NUM_LAZY_LOAD_COLUMNS).
  ...
  public function delete($con = null)
  {
    ...
    if ($this->getDispatcher()->getListeners('Crosselling.preDelete')) {
        $this->getDispatcher()->notify(new sfEvent($this, 'Crosselling.preDelete', array('con' => $con)));
    }

    if (sfMixer::hasCallables('BaseCrosselling:delete:pre'))
    {
    ...
    if ($this->getDispatcher()->getListeners('Crosselling.postDelete')) {
        $this->getDispatcher()->notify(new sfEvent($this, 'Crosselling.postDelete', array('con' => $con)));
    }

    if (sfMixer::hasCallables('BaseCrosselling:delete:post'))
    {
  ...
  public function save($con = null)
  {
    ...
    if (!$this->alreadyInSave) {
      if ($this->getDispatcher()->getListeners('Crosselling.preSave')) {
    ...
    try {
      ...
      if (!$this->alreadyInSave) {
        if ($this->getDispatcher()->getListeners('Crosselling.postSave')) {
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Crosselling (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Crosselling Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getProductRelatedByFirstProductId($con = null)
	{
		if ($this->aProductRelatedByFirstProductId === null && ($this->first_product_id !== null)) {
			...
			/* The following can be used instead of the line above to
			   ...
			   never be used.
			   $obj = ProductPeer::retrieveByPK($this->first_product_id, $con);
			   $obj->addProductsRelatedByFirstProductId($this);
			 */
		}
	...
	public function getProductRelatedBySecoundProductId($con = null)
	{
		if ($this->aProductRelatedBySecoundProductId === null && ($this->secound_product_id !== null)) {
			...
			/* The following can be used instead of the line above to
			   ...
			   As it can lead to a db query with many results that may
			   never be used.
			   $obj = ProductPeer::retrieveByPK($this->secound_product_id, $con);
			   $obj->addProductsRelatedBySecoundProductId($this);
			 */
		}
