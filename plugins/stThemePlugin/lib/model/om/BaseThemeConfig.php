...
abstract class BaseThemeConfig extends BaseObject  implements Persistent {
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
              ...
              if (null !== $this->parameters && $this->isColumnModified(ThemeConfigPeer::PARAMETERS)) {
 ...
 // [HL] After being saved an object is no longer 'modified'
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ThemeConfigPeer::PARAMETERS)) $criteria->add(ThemeConfigPeer::PARAMETERS, $this->parameters);
