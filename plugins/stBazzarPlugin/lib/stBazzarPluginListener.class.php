 ...
 * @version     $Id: stBazzarPluginListener.class.php 10 2009-08-24 09:32:18Z michal $
 * @author      Piotr Halas <piotr.halas@sote.pl>
 */
 
/** 
 * Klasa stBazzarPluginListener
 *
 * @package     stBazzarPlugin
 * @subpackage  libs
 */
class stBazzarPluginListener
{
    /** 
    ...
    public static function generate(sfEvent $event)
    {
        ...
        $event->getSubject()->attachAdminGeneratorFile('stBazzarPlugin', 'stBazzarInProduct.yml');
    }
}