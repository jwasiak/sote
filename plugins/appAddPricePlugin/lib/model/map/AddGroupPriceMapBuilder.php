...
/**
 * This class adds structure of 'app_add_group_price' table to 'propel' DatabaseMap object.
 *
 *
 *
 ...
 */
class AddGroupPriceMapBuilder {

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'plugins.appAddPricePlugin.lib.model.map.AddGroupPriceMapBuilder';
    ...
    public function doBuild()
    {
        ...
        $tMap = $this->dbMap->addTable('app_add_group_price');
        $tMap->setPhpName('AddGroupPrice');
        ...
        $tMap->addForeignPrimaryKey('ID', 'Id', 'int' , CreoleTypes::INTEGER, 'st_group_price', 'ID', true, null);
