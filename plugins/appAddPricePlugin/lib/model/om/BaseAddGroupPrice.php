...
/**
 * Base class that represents a row from the 'app_add_group_price' table.
 *
 * 
 *
 * @package    plugins.appAddPricePlugin.lib.model.om
 */
abstract class BaseAddGroupPrice extends BaseObject  implements Persistent {
	...
	public function setCreatedAt($v)
	{
		...
		if ($this->created_at !== $ts) {
			$this->created_at = $ts;
			$this->modifiedColumns[] = AddGroupPricePeer::CREATED_AT;
		}
	...
	public function setUpdatedAt($v)
	{
		...
		if ($this->updated_at !== $ts) {
			$this->updated_at = $ts;
			$this->modifiedColumns[] = AddGroupPricePeer::UPDATED_AT;
		}
	...
	public function setId($v)
	{
        ...
        if ($this->id !== $v) {
          $this->id = $v;
          $this->modifiedColumns[] = AddGroupPricePeer::ID;
        }
	...
	public function setCurrencyId($v)
	{
        ...
        if ($this->currency_id !== $v) {
          $this->currency_id = $v;
          $this->modifiedColumns[] = AddGroupPricePeer::CURRENCY_ID;
        }
	...
	public function setTaxId($v)
	{
        ...
        if ($this->tax_id !== $v) {
          $this->tax_id = $v;
          $this->modifiedColumns[] = AddGroupPricePeer::TAX_ID;
        }
	...
	public function setOptVat($v)
	{
        ...
        if ($this->opt_vat !== $v) {
          $this->opt_vat = $v;
          $this->modifiedColumns[] = AddGroupPricePeer::OPT_VAT;
        }
	...
	public function setPriceNetto($v)
	{
        ...
        if ($this->price_netto !== $v) {
          $this->price_netto = $v;
          $this->modifiedColumns[] = AddGroupPricePeer::PRICE_NETTO;
        }
	...
	public function setPriceBrutto($v)
	{
        ...
        if ($this->price_brutto !== $v) {
          $this->price_brutto = $v;
          $this->modifiedColumns[] = AddGroupPricePeer::PRICE_BRUTTO;
        }
	...
	public function setOldPriceNetto($v)
	{
        ...
        if ($this->old_price_netto !== $v) {
          ...
          $this->modifiedColumns[] = AddGroupPricePeer::OLD_PRICE_NETTO;
        }
	...
	public function setOldPriceBrutto($v)
	{
        ...
        if ($this->old_price_brutto !== $v) {
          ...
          $this->modifiedColumns[] = AddGroupPricePeer::OLD_PRICE_BRUTTO;
        }
	...
	public function setWholesaleANetto($v)
	{
        ...
        if ($this->wholesale_a_netto !== $v) {
          ...
          $this->modifiedColumns[] = AddGroupPricePeer::WHOLESALE_A_NETTO;
        }
	...
	public function setWholesaleABrutto($v)
	{
        ...
        if ($this->wholesale_a_brutto !== $v) {
          ...
          $this->modifiedColumns[] = AddGroupPricePeer::WHOLESALE_A_BRUTTO;
        }
	...
	public function setWholesaleBNetto($v)
	{
        ...
        if ($this->wholesale_b_netto !== $v) {
          ...
          $this->modifiedColumns[] = AddGroupPricePeer::WHOLESALE_B_NETTO;
        }
	...
	public function setWholesaleBBrutto($v)
	{
        ...
        if ($this->wholesale_b_brutto !== $v) {
          ...
          $this->modifiedColumns[] = AddGroupPricePeer::WHOLESALE_B_BRUTTO;
        }
	...
	public function setWholesaleCNetto($v)
	{
        ...
        if ($this->wholesale_c_netto !== $v) {
          ...
          $this->modifiedColumns[] = AddGroupPricePeer::WHOLESALE_C_NETTO;
        }
	...
	public function setWholesaleCBrutto($v)
	{
        ...
        if ($this->wholesale_c_brutto !== $v) {
          ...
          $this->modifiedColumns[] = AddGroupPricePeer::WHOLESALE_C_BRUTTO;
        }
  ...
  {
    try {
      if ($this->getDispatcher()->getListeners('AddGroupPrice.preHydrate')) {
          $event = $this->getDispatcher()->notify(new sfEvent($this, 'AddGroupPrice.preHydrate', array('resultset' => $rs, 'startcol' => $startcol)));
      ...
      $this->setNew(false);
      if ($this->getDispatcher()->getListeners('AddGroupPrice.postHydrate')) {
          $event = $this->getDispatcher()->notify(new sfEvent($this, 'AddGroupPrice.postHydrate', array('resultset' => $rs, 'startcol' => $startcol + 16)));
          return $event['startcol'];
      }

      // FIXME - using NUM_COLUMNS may be clearer.
      return $startcol + 16; // 16 = AddGroupPricePeer::NUM_COLUMNS - AddGroupPricePeer::NUM_LAZY_LOAD_COLUMNS).

    } catch (Exception $e) {
      throw new PropelException("Error populating AddGroupPrice object", $e);
    }
  }
  ...
  public function delete($con = null)
  {
    ...
    if ($this->getDispatcher()->getListeners('AddGroupPrice.preDelete')) {
        $this->getDispatcher()->notify(new sfEvent($this, 'AddGroupPrice.preDelete', array('con' => $con)));
    }

    if (sfMixer::hasCallables('BaseAddGroupPrice:delete:pre'))
    {
      foreach (sfMixer::getCallables('BaseAddGroupPrice:delete:pre') as $callable)
      {
    ...
    try {
      $con->begin();
      AddGroupPricePeer::doDelete($this, $con);
    ...
    if ($this->getDispatcher()->getListeners('AddGroupPrice.postDelete')) {
        $this->getDispatcher()->notify(new sfEvent($this, 'AddGroupPrice.postDelete', array('con' => $con)));
    }

    if (sfMixer::hasCallables('BaseAddGroupPrice:delete:post'))
    {
      foreach (sfMixer::getCallables('BaseAddGroupPrice:delete:post') as $callable)
      {
  ...
  public function save($con = null)
  {
    ...
    if (!$this->alreadyInSave) {
      if ($this->getDispatcher()->getListeners('AddGroupPrice.preSave')) {
          $this->getDispatcher()->notify(new sfEvent($this, 'AddGroupPrice.preSave', array('con' => $con)));
      }

      foreach (sfMixer::getCallables('BaseAddGroupPrice:save:pre') as $callable)
      {
    ...
    if ($this->isNew() && !$this->isColumnModified(AddGroupPricePeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
    }

    if ($this->isModified() && !$this->isColumnModified(AddGroupPricePeer::UPDATED_AT))
    {
    ...
    try {
      ...
      if (!$this->alreadyInSave) {
        if ($this->getDispatcher()->getListeners('AddGroupPrice.postSave')) {
            $this->getDispatcher()->notify(new sfEvent($this, 'AddGroupPrice.postSave', array('con' => $con)));
        }
     
        foreach (sfMixer::getCallables('BaseAddGroupPrice:save:post') as $callable)
        {
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = AddGroupPricePeer::doInsert($this, $con);
					...
					$affectedRows += AddGroupPricePeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = AddGroupPricePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = AddGroupPricePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = AddGroupPricePeer::getFieldNames($keyType);
		$result = array(
	...
	{
		$criteria = new Criteria(AddGroupPricePeer::DATABASE_NAME);

		if ($this->isColumnModified(AddGroupPricePeer::CREATED_AT)) $criteria->add(AddGroupPricePeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(AddGroupPricePeer::UPDATED_AT)) $criteria->add(AddGroupPricePeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(AddGroupPricePeer::ID)) $criteria->add(AddGroupPricePeer::ID, $this->id);
		if ($this->isColumnModified(AddGroupPricePeer::CURRENCY_ID)) $criteria->add(AddGroupPricePeer::CURRENCY_ID, $this->currency_id);
		if ($this->isColumnModified(AddGroupPricePeer::TAX_ID)) $criteria->add(AddGroupPricePeer::TAX_ID, $this->tax_id);
		if ($this->isColumnModified(AddGroupPricePeer::OPT_VAT)) $criteria->add(AddGroupPricePeer::OPT_VAT, $this->opt_vat);
		if ($this->isColumnModified(AddGroupPricePeer::PRICE_NETTO)) $criteria->add(AddGroupPricePeer::PRICE_NETTO, $this->price_netto);
		if ($this->isColumnModified(AddGroupPricePeer::PRICE_BRUTTO)) $criteria->add(AddGroupPricePeer::PRICE_BRUTTO, $this->price_brutto);
		if ($this->isColumnModified(AddGroupPricePeer::OLD_PRICE_NETTO)) $criteria->add(AddGroupPricePeer::OLD_PRICE_NETTO, $this->old_price_netto);
		if ($this->isColumnModified(AddGroupPricePeer::OLD_PRICE_BRUTTO)) $criteria->add(AddGroupPricePeer::OLD_PRICE_BRUTTO, $this->old_price_brutto);
		if ($this->isColumnModified(AddGroupPricePeer::WHOLESALE_A_NETTO)) $criteria->add(AddGroupPricePeer::WHOLESALE_A_NETTO, $this->wholesale_a_netto);
		if ($this->isColumnModified(AddGroupPricePeer::WHOLESALE_A_BRUTTO)) $criteria->add(AddGroupPricePeer::WHOLESALE_A_BRUTTO, $this->wholesale_a_brutto);
		if ($this->isColumnModified(AddGroupPricePeer::WHOLESALE_B_NETTO)) $criteria->add(AddGroupPricePeer::WHOLESALE_B_NETTO, $this->wholesale_b_netto);
		if ($this->isColumnModified(AddGroupPricePeer::WHOLESALE_B_BRUTTO)) $criteria->add(AddGroupPricePeer::WHOLESALE_B_BRUTTO, $this->wholesale_b_brutto);
		if ($this->isColumnModified(AddGroupPricePeer::WHOLESALE_C_NETTO)) $criteria->add(AddGroupPricePeer::WHOLESALE_C_NETTO, $this->wholesale_c_netto);
		if ($this->isColumnModified(AddGroupPricePeer::WHOLESALE_C_BRUTTO)) $criteria->add(AddGroupPricePeer::WHOLESALE_C_BRUTTO, $this->wholesale_c_brutto);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(AddGroupPricePeer::ID, $this->id);
		$criteria->add(AddGroupPricePeer::CURRENCY_ID, $this->currency_id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of AddGroupPrice (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     AddGroupPrice Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     AddGroupPricePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new AddGroupPricePeer();
		}
		return self::$peer;
	}
	...
	{
		if ($this->aGroupPrice === null && ($this->id !== null)) {
			// include the related Peer class
			$this->aGroupPrice = GroupPricePeer::retrieveByPK($this->id, $con);
			...
			/* The following can be used instead of the line above to
			   ...
			   never be used.
			   $obj = GroupPricePeer::retrieveByPK($this->id, $con);
  ...
  {
      $event = $this->getDispatcher()->notifyUntil(new sfEvent($this, 'AddGroupPrice.' . $method, array('arguments' => $arguments, 'method' => $method)));
      ...
      if (!$callable = sfMixer::getCallable('BaseAddGroupPrice:'.$method))
      {
        throw new sfException(sprintf('Call to undefined method BaseAddGroupPrice::%s', $method));
      }
