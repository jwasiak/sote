 ...
 * @version     $Id: stOkazjePluginListener.class.php 10 2009-08-24 09:32:18Z michal $
...
class stOkazjePluginListener
{
    ...
    public static function generate(sfEvent $event)
    {
        ...
        $event->getSubject()->attachAdminGeneratorFile('stOkazjePlugin', 'stOkazjeInProduct.yml');
    }
}