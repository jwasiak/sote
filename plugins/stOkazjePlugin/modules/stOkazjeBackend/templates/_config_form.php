<?php echo form_tag('stOkazjeBackend/config', array('id' => 'sf_admin_config_form', 'name' => 'sf_admin_config_form', 'multipart' => true));?>
    ...
    <fieldset id="sf_fieldset_none" class="">
        ...
        <div class="st_fieldset-content" id="sf_fieldset_none_slide">
            <?php foreach(stOkazje::getAvailabilities() as $availability):?>
                <div class="form-row">
