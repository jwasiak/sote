...
abstract class BaseOnlineFilesPeer {
	...
	const MEDIA_TYPE = 'app_online_files.MEDIA_TYPE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('CreatedAt', 'UpdatedAt', 'Id', 'ProductId', 'Name', 'Filename', 'MediaType', ),
		BasePeer::TYPE_COLNAME => array (OnlineFilesPeer::CREATED_AT, OnlineFilesPeer::UPDATED_AT, OnlineFilesPeer::ID, OnlineFilesPeer::PRODUCT_ID, OnlineFilesPeer::NAME, OnlineFilesPeer::FILENAME, OnlineFilesPeer::MEDIA_TYPE, ),
		BasePeer::TYPE_FIELDNAME => array ('created_at', 'updated_at', 'id', 'product_id', 'name', 'filename', 'media_type', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('CreatedAt' => 0, 'UpdatedAt' => 1, 'Id' => 2, 'ProductId' => 3, 'Name' => 4, 'Filename' => 5, 'MediaType' => 6, ),
		BasePeer::TYPE_COLNAME => array (OnlineFilesPeer::CREATED_AT => 0, OnlineFilesPeer::UPDATED_AT => 1, OnlineFilesPeer::ID => 2, OnlineFilesPeer::PRODUCT_ID => 3, OnlineFilesPeer::NAME => 4, OnlineFilesPeer::FILENAME => 5, OnlineFilesPeer::MEDIA_TYPE => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('created_at' => 0, 'updated_at' => 1, 'id' => 2, 'product_id' => 3, 'name' => 4, 'filename' => 5, 'media_type' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(OnlineFilesPeer::MEDIA_TYPE);
	 ...
	 *
	 * @return     array Array of OnlineFiles objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
