<?php
stPluginHelper::addEnableModule('sfTCPDF', 'backend');
stPluginHelper::addEnableModule('sfTCPDF', 'frontend');
...
// PLEASE SET THE FOLLOWING CONSTANTS:
     ...
     * blank image
     */
    define ("K_BLANK_IMAGE", sfConfig::get('sf_web_dir')."/plugins/sfTCPDFPlugin/images/_blank.png");
...
define('K_TCPDF_EXTERNAL_CONFIG', true);
     ...
     * image logo
     */
    define ("PDF_HEADER_LOGO", sfConfig::get('sf_web_dir')."/plugins/sfTCPDFPlugin/images/logo_example.png");
