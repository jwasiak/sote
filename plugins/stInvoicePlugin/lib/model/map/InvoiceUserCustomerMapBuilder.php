...
/**
 * This class adds structure of 'st_invoice_user_customer' table to 'propel' DatabaseMap object.
 *
 *
 *
 ...
 */
class InvoiceUserCustomerMapBuilder {

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'plugins.stInvoicePlugin.lib.model.map.InvoiceUserCustomerMapBuilder';
    ...
    public function doBuild()
    {
        ...
        $tMap = $this->dbMap->addTable('st_invoice_user_customer');
        $tMap->setPhpName('InvoiceUserCustomer');
