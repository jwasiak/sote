 ...
 * @version     $Id: stOnetPluginListener.class.php 10 2009-08-24 09:32:18Z michal $
...
class stOnetPluginListener
{
    ...
    public static function generate(sfEvent $event)
    {
        ...
        $event->getSubject()->attachAdminGeneratorFile('stOnetPlugin', 'stOnetInProduct.yml');
    }
}