...
/**
 * Base class that represents a row from the 'st_webpage_i18n' table.
 *
 * 
 *
...
abstract class BaseWebpageI18n extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the other_link field.
	 * @var        string
	 */
	protected $other_link;
    ...
    /**
     * Get the [other_link] column value.
     * 
     * @return     string
     */
	...
	/**
	 * Set the value of [other_link] column.
	 * 
	 * @param      string $v new value
	 * @return     void
	 */
	public function setOtherLink($v)
	{
        ...
        if ($this->other_link !== $v) {
          $this->other_link = $v;
          $this->modifiedColumns[] = WebpageI18nPeer::OTHER_LINK;
        }
	...
	public function setTarget($v)
	{
        ...
        if ($this->target !== $v) {
          $this->target = $v;
          $this->modifiedColumns[] = WebpageI18nPeer::TARGET;
        }
  ...
  {
    try {
      if ($this->getDispatcher()->getListeners('WebpageI18n.preHydrate')) {
          $event = $this->getDispatcher()->notify(new sfEvent($this, 'WebpageI18n.preHydrate', array('resultset' => $rs, 'startcol' => $startcol)));
      ...
      $this->other_link = $rs->getString($startcol + 5);

      $this->target = $rs->getBoolean($startcol + 6);

      $this->resetModified();

      $this->setNew(false);
      if ($this->getDispatcher()->getListeners('WebpageI18n.postHydrate')) {
          $event = $this->getDispatcher()->notify(new sfEvent($this, 'WebpageI18n.postHydrate', array('resultset' => $rs, 'startcol' => $startcol + 7)));
          return $event['startcol'];
      }

      // FIXME - using NUM_COLUMNS may be clearer.
      return $startcol + 7; // 7 = WebpageI18nPeer::NUM_COLUMNS - WebpageI18nPeer::NUM_LAZY_LOAD_COLUMNS).
  ...
  public function delete($con = null)
  {
    ...
    if ($this->getDispatcher()->getListeners('WebpageI18n.preDelete')) {
        $this->getDispatcher()->notify(new sfEvent($this, 'WebpageI18n.preDelete', array('con' => $con)));
    }

    if (sfMixer::hasCallables('BaseWebpageI18n:delete:pre'))
    {
    ...
    if ($this->getDispatcher()->getListeners('WebpageI18n.postDelete')) {
        $this->getDispatcher()->notify(new sfEvent($this, 'WebpageI18n.postDelete', array('con' => $con)));
    }

    if (sfMixer::hasCallables('BaseWebpageI18n:delete:post'))
    {
  ...
  public function save($con = null)
  {
    ...
    if (!$this->alreadyInSave) {
      if ($this->getDispatcher()->getListeners('WebpageI18n.preSave')) {
    ...
    try {
      ...
      if (!$this->alreadyInSave) {
        if ($this->getDispatcher()->getListeners('WebpageI18n.postSave')) {
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[5], $arr)) $this->setOtherLink($arr[$keys[5]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(WebpageI18nPeer::OTHER_LINK)) $criteria->add(WebpageI18nPeer::OTHER_LINK, $this->other_link);
		if ($this->isColumnModified(WebpageI18nPeer::TARGET)) $criteria->add(WebpageI18nPeer::TARGET, $this->target);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of WebpageI18n (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setOtherLink($this->other_link);
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     WebpageI18n Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getWebpage($con = null)
	{
		if ($this->aWebpage === null && ($this->id !== null)) {
			...
			/* The following can be used instead of the line above to
			   ...
			   never be used.
			   $obj = WebpagePeer::retrieveByPK($this->id, $con);
