...
/**
 * This class adds structure of 'st_webpage' table to 'propel' DatabaseMap object.
 *
 *
 *
 ...
 */
class WebpageMapBuilder {

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'plugins.stWebpagePlugin.lib.model.map.WebpageMapBuilder';
    ...
    public function doBuild()
    {
        ...
        $tMap = $this->dbMap->addTable('st_webpage');
        $tMap->setPhpName('Webpage');
