...
<?php use_helper('Number', 'stCurrency', 'Date', 'stUrl', 'stProductImage') ?>
<!-- HEADER -->
            ...
            <table style="margin: 0;padding: 0;font-family: Arial, sans-serif;font-size: 12px;width: 100%;">
                <tr style="margin: 0;padding: 0;font-family: Arial, sans-serif;font-size: 12px;">
                    <td style="margin: 0;padding: 0;font-family: Arial, sans-serif;font-size: 12px;">
                        <p style="margin: 0;padding: 0;font-family: Arial, sans-serif;font-size: 12px;margin-bottom: 10px;font-weight: normal;line-height: 1.6;"><?php echo $head; ?></p>
                        <h4 style="margin: 0;padding: 0;font-family: &quot;HelveticaNeue-Light&quot;, &quot;Helvetica Neue Light&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, &quot;Lucida Grande&quot;, sans-serif;font-size: 23px;line-height: 1.1;margin-bottom: 15px;color: #000;font-weight: 500;"><?php echo $mail_subject; ?></h4>
                    
                        <div class="product_photo" style="border: none; float:left; width: 200px;">
                            <?php if ($product): ?>
                                <?php echo st_link_to(st_product_image_tag($product, 'small', array('absolute' => true, 'for_app' => 'frontend', 'style' => 'border: none;')), 'stProduct/showFrontend?url='.$product->getFriendlyUrl(), array('absolute' => true, 'for_app' => 'frontend', 'no_script_name' => true, 'style' => 'border: none;')) ?>
                            <?php endif; ?>
                        </div>                                               
                        
                        
                        <div class="product_char" style="float:right; padding: 10px; width: 300px;">
                            <p style="margin: 0;padding: 0;font-family: Arial, sans-serif;font-size: 16px;margin-bottom: 10px;font-weight: bold;line-height: 1.6;">
                                <?php if ($product): ?>
                                    <?php echo st_link_to($product_name, 'stProduct/showFrontend?url='.$product->getFriendlyUrl(), array('absolute' => true, 'for_app' => 'frontend', 'no_script_name' => true, 'style' => 'font-weight: bold; text-decoration: none; color:#576278;')) ?>
                                <?php else: ?>
                            ...
                            <p style="margin: 0;padding: 0;font-family: Arial, sans-serif;font-size: 12px;margin-bottom: 10px;font-weight: normal;line-height: 1.6;">
                                <?php echo __("Kod produktu:") ?> <span><?php echo $product_code ?></span>
                            </p>
                            <?php endif; ?>
                            <?php if ($product_producer): ?>
                            <p style="margin: 0;padding: 0;font-family: Arial, sans-serif;font-size: 12px;margin-bottom: 10px;font-weight: normal;line-height: 1.6;">
                                <?php echo __("Producent:") ?> <span><?php echo $product_producer ?></span>
                            </p>
                            <?php endif; ?>
                            <?php if ($product_category): ?>
                            <p style="margin: 0;padding: 0;font-family: Arial, sans-serif;font-size: 12px;margin-bottom: 10px;font-weight: normal;line-height: 1.6;">
                                <?php echo __("Kategoria:") ?> <span><?php echo $product_category ?></span>
                            </p>
                            <?php endif; ?>
                            <?php if ($product): ?>
                            <!-- Callout Panel -->
                            <p class="callout" style="text-align: center;margin: 0;padding: 15px;font-family: Arial, sans-serif;font-size: 12px;margin-bottom: 15px;font-weight: normal;line-height: 1.6;background-color: #<?php echo $mail_config->get('bg_action_color'); ?>;">                                
                                <a href="<?php echo st_url_for('stProduct/showFrontend?url='.$product->getFriendlyUrl(), true, 'frontend') ?>" style="margin: 0;padding: 0;font-family: Arial, sans-serif;font-size: 12px;color: #<?php echo $mail_config->get('bg_action_link_color'); ?>;font-weight: bold;"><?php echo __("Przejdź do produktu"); ?></a>
                            </p><!-- /Callout Panel -->
                            <?php endif; ?>       
                        ...
                        <?php if ($question->getAnswerText()!=""): ?>
                        <p style="margin: 0;padding: 0;font-family: Arial, sans-serif;font-size: 12px;margin-bottom: 10px;font-weight: normal;line-height: 1.6;">
                        <?php echo __('Treść odpowiedzi:')?></br><?php echo $question->getAnswerText()?>
                        </p>
                        <?php endif; ?>

                        
                        <!-- social & contact -->
                        <table class="social" width="100%" style="margin: 0;padding: 0;font-family: Arial, sans-serif;font-size: 12px;background-color: #<?php echo $mail_config->get('bg_footer_color'); ?>;width: 100%;">
                            <tr style="margin: 0;padding: 0;font-family: Arial, sans-serif;font-size: 12px;">
                                <td style="margin: 0;padding: 0;font-family: Arial, sans-serif;font-size: 12px;"><?php echo $foot; ?></td>
                            </tr>
