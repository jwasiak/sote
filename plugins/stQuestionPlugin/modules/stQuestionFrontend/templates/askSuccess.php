...
$smarty->assign('form_start', form_tag('question/send?product_id='.$product_id));
...
if($login_required==false)
{
    ...
    {
        $smarty->assign('email', input_tag('question[email]', '', array('id'=>'st_application-question-email', 'size' => 50, 'class'=>form_has_error('email') ? 'st_form-error' : '')));
    }
}
else
{
...
$smarty->display('question_ask.html');
?>