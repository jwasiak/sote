...
class Unescaper
{
    ...
    public function unescapeDoubleQuotedStringHelper($match) {
    ...
    {
        return preg_replace_callback('/'.self::REGEX_ESCAPED_CHARACTER.'/u', array($this, 'unescapeDoubleQuotedStringHelper') , $value);
    }
