...
array(), 'stAdminGeneratorPlugin'), 'route' => 'appProductAttributeBackend/import')) ?>
    <?php st_include_component('appProductAttributeBackend', 'listMenu', array('app_product_attribute' => null)) ?>
                    
                    <div id="sf_admin_content">
                    <?php st_include_partial('appProductAttributeBackend/import_messages', array( 'labels' => array('filename' => __('Plik z danymi', array(), 'stImportExportBackend'), 'importer' => __('Wybierz format importu', array(), 'stImportExportBackend') ))) ?>
                        <?php if (!$import): ?>
                                <?php echo form_tag('appProductAttributeBackend/import',array('multipart'=>true,'id'=>'sf_admin_config_form')) ?>
