 ...
 * @version    SVN: $Id: sfPropelDatabaseSchema.class.php 4 2008-09-24 08:40:58Z marek $
 */
class sfPropelDatabaseSchema
{
    ...
    public function loadYAML($file)
    {
        ...
        if (class_exists('pakeFinder'))
        {
            ...
            $custom_schema_filename = str_replace('schema.yml', 'schema.custom.yml', basename($file));

            if (strpos($file, DIRECTORY_SEPARATOR . 'plugins' . DIRECTORY_SEPARATOR) !== false)
            {
                $plugin_name = basename(dirname(dirname($file)));

                $custom_schema_filename = $plugin_name . '_' . $custom_schema_filename;
            }
