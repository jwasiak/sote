 ...
 * @version     $Id: stOferciak.class.php 10 2009-08-24 09:32:18Z michal $
 ...
 * @subpackage  libs
 */
class stOferciak extends stPriceCompareGenerateFile implements stPriceCompareGenerateFileInterface
{
    /**
     * Konstruktor
     */
    ...
    protected function getFileBody($step)
    {
        ...
        foreach ($priceCompareProducts as $priceCompareProduct)
        {
            ...
            if ($parsedProduct->checkProduct())
            {
                ...
                $productContent.= xml_cdata_tag('category', $parsedProduct->getCategoryName());
    ...
    protected function getFileFoot()
    {
        ...
        $content.= xml_close_tag('oferciak');
        return $content;
    }
