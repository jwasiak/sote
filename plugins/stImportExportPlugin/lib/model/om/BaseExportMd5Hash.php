...
abstract class BaseExportMd5Hash extends BaseObject  implements Persistent {
  ...
  public function save($con = null)
  {
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
              $o_md5hash = $this->md5hash;
              if (null !== $this->md5hash && $this->isColumnModified(ExportMd5HashPeer::MD5HASH)) {
                  $this->md5hash = serialize($this->md5hash);
              }
 ...
 // [HL] After being saved an object is no longer 'modified'
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ExportMd5HashPeer::MD5HASH)) $criteria->add(ExportMd5HashPeer::MD5HASH, $this->md5hash);
	...
	{
		if (self::$peer === null) {
			self::$peer = new ExportMd5HashPeer();
		}
		return self::$peer;
	}
