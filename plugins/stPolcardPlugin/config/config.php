 ...
 * Włączanie modułu
 */
stPluginHelper::addEnableModule('stPolcardBackend', 'backend');
stPluginHelper::addEnableModule('stPolcardFrontend', 'frontend');
 ...
 */
stLicenseTypeHelper::addCommercialModule('stPolcardPlugin');