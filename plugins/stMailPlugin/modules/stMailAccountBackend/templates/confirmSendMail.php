            ...
            <table cellpadding="0" cellspacing="0" style="margin: 0;padding: 0;font-family: Arial, sans-serif;width: 100%;">
                <tr style="margin: 0;padding: 0;font-family: Arial, sans-serif;">
                    <td style="margin: 0;padding: 0;font-family: Arial, sans-serif;">
                        ...
                        <h4 style="margin: 0;padding: 0;font-family: &quot;helveticaneue-light&quot: ;, &quot: ;helvetica neue light&quot: ;helvetica neue&quot: ;, helvetica, arial, &quot: ;lucida grande&quot: ;, sans-serif: ;line-height: 1.1;margin-bottom: 15px;color: #000;font-weight: 500;font-size: 23px;"><?php echo __('Konfiguracja e-mail - sklep') ?></h4>
                                 </br>                   
                        <p class="callout" style="text-align: center;margin: 0;padding: 15px;font-family: Arial, sans-serif;font-size: 12px;margin-bottom: 15px;font-weight: normal;line-height: 1.6;background-color: #DFF0D8;">                                                       
                            <span style="font-size:12px; color:#468847;"><?php echo __('Główne konto sklepu zostało poprawnie skonfigurowane.') ?></span>
                        </p>                                                    
                                                                
                        <p style="font-size:12px; text-align: center;">
                            <?php echo __('Informacje o zamówieniach oraz pytania do zamówień będą przychodziły na adres:') ?>
                            </br>
                            <span style="font-size:16px;"><center><b><?php echo $mail?></b></center></span>
                        </p>
                        
                        <p style="font-size:12px; text-align: center; color: #ccc;">
                            <?php echo __('Nie odpowiadaj na tą wiadomość, została ona wygenerowany automatycznie przez system.') ?>
                        </p>           
