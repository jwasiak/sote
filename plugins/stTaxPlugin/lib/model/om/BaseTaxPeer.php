...
abstract class BaseTaxPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Vat', 'IsDefault', 'IsActive', 'VatName', 'IsSystemDefault', 'UpdateResume', ),
		BasePeer::TYPE_COLNAME => array (TaxPeer::ID, TaxPeer::VAT, TaxPeer::IS_DEFAULT, TaxPeer::IS_ACTIVE, TaxPeer::VAT_NAME, TaxPeer::IS_SYSTEM_DEFAULT, TaxPeer::UPDATE_RESUME, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'vat', 'is_default', 'is_active', 'vat_name', 'is_system_default', 'update_resume', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Vat' => 1, 'IsDefault' => 2, 'IsActive' => 3, 'VatName' => 4, 'IsSystemDefault' => 5, 'UpdateResume' => 6, ),
		BasePeer::TYPE_COLNAME => array (TaxPeer::ID => 0, TaxPeer::VAT => 1, TaxPeer::IS_DEFAULT => 2, TaxPeer::IS_ACTIVE => 3, TaxPeer::VAT_NAME => 4, TaxPeer::IS_SYSTEM_DEFAULT => 5, TaxPeer::UPDATE_RESUME => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'vat' => 1, 'is_default' => 2, 'is_active' => 3, 'vat_name' => 4, 'is_system_default' => 5, 'update_resume' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
