 ...
 * @version     $Id: stSklepy24PluginListener.class.php 10 2009-08-24 09:32:18Z michal $
 ...
 * @subpackage  libs
 */
class stSklepy24PluginListener
{
    /** 
    ...
    public static function generate(sfEvent $event)
    {
        ...
        $event->getSubject()->attachAdminGeneratorFile('stSklepy24Plugin', 'stSklepy24InProduct.yml');
    }
}