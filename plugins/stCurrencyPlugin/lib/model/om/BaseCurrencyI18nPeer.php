...
/**
 * Base static class for performing query and update operations on the 'st_currency_i18n' table.
 *
 * 
 *
...
abstract class BaseCurrencyI18nPeer {
	...
	const TABLE_NAME = 'st_currency_i18n';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'plugins.stCurrencyPlugin.lib.model.CurrencyI18n';
	...
	const ID = 'st_currency_i18n.ID';

	/** the column name for the CULTURE field */
	const CULTURE = 'st_currency_i18n.CULTURE';

	/** the column name for the NAME field */
	const NAME = 'st_currency_i18n.NAME';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (CurrencyI18nPeer::ID, CurrencyI18nPeer::CULTURE, CurrencyI18nPeer::NAME, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (CurrencyI18nPeer::ID => 0, CurrencyI18nPeer::CULTURE => 1, CurrencyI18nPeer::NAME => 2, ),
	...
	{
		return BasePeer::getMapBuilder('plugins.stCurrencyPlugin.lib.model.map.CurrencyI18nMapBuilder');
	}
	/**
	 ...
	 * @param      string $column The column name for current table. (i.e. CurrencyI18nPeer::COLUMN_NAME).
	 * @return     string
	 */
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CurrencyI18nPeer::NAME);


		if (stEventDispatcher::getInstance()->getListeners('CurrencyI18nPeer.postAddSelectColumns')) {
			stEventDispatcher::getInstance()->notify(new sfEvent($criteria, 'CurrencyI18nPeer.postAddSelectColumns'));
		}
	}

	const COUNT = 'COUNT(st_currency_i18n.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT st_currency_i18n.ID)';
	...
	/**
	 * Selects a collection of CurrencyI18n objects pre-filled with their Currency objects.
	 *
	 * @return     array Array of CurrencyI18n objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinCurrency(Criteria $c, $con = null)
	{
		...
		$rs = CurrencyI18nPeer::doSelectRs($c, $con);
	...
	/**
	 * Selects a collection of CurrencyI18n objects pre-filled with all related objects.
	 *
	 * @return     array Array of CurrencyI18n objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				...
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
					$temp_obj2->addCurrencyI18n($obj1); // CHECKME
					break;
				}
			}
	...
	/**
	 * Method perform an INSERT on the database, given a CurrencyI18n or Criteria object.
	 *
	 * @param      mixed $values Criteria or CurrencyI18n object containing data that is used to create the INSERT statement.
	 * @param      Connection $con the connection to use
    ...
    foreach (sfMixer::getCallables('BaseCurrencyI18nPeer:doInsert:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from CurrencyI18n object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a CurrencyI18n or Criteria object.
	 *
	 * @param      mixed $values Criteria or CurrencyI18n object containing data that is used to create the UPDATE statement.
    ...
    foreach (sfMixer::getCallables('BaseCurrencyI18nPeer:doUpdate:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		} else { // $values is CurrencyI18n object
	...
	/**
	 * Method to DELETE all rows from the st_currency_i18n table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a CurrencyI18n or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; // rename for clarity
		} elseif ($values instanceof CurrencyI18n) {
	...
	/**
	 * Validates all modified columns of given CurrencyI18n object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      CurrencyI18n $obj The object to validate.
...
if (Propel::isInit()) {
	...
	Propel::registerMapBuilder('plugins.stCurrencyPlugin.lib.model.map.CurrencyI18nMapBuilder');
}
