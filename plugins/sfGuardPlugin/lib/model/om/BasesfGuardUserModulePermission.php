...
abstract class BasesfGuardUserModulePermission extends BaseObject  implements Persistent {
	 ...
	 * @var        sfGuardUserModulePermissionPeer
	 */
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
              ...
              if (null !== $this->permissions && $this->isColumnModified(sfGuardUserModulePermissionPeer::PERMISSIONS)) {
 ...
 // [HL] After being saved an object is no longer 'modified'
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(sfGuardUserModulePermissionPeer::PERMISSIONS)) $criteria->add(sfGuardUserModulePermissionPeer::PERMISSIONS, $this->permissions);
	...
	{
		if (self::$peer === null) {
			self::$peer = new sfGuardUserModulePermissionPeer();
		}
		return self::$peer;
	}
