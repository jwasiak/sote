...
abstract class BasesfGuardUserPermissionPeer {
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		if (stEventDispatcher::getInstance()->getListeners('sfGuardUserPermissionPeer.postAddSelectColumns')) {
			stEventDispatcher::getInstance()->notify(new sfEvent($criteria, 'sfGuardUserPermissionPeer.postAddSelectColumns'));
		}
	}
	...
	public static function doSelectJoinsfGuardUser(Criteria $c, $con = null)
	{
		...
		$rs = sfGuardUserPermissionPeer::doSelectRs($c, $con);
		...
		while($rs->next()) {
			...
			$obj1 = new sfGuardUserPermission();
