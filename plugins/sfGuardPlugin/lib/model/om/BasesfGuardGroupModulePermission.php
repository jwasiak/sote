...
abstract class BasesfGuardGroupModulePermission extends BaseObject  implements Persistent {
	 ...
	 * @var        sfGuardGroupModulePermissionPeer
	 */
  ...
  public function save($con = null)
  {
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
              $o_permissions = $this->permissions;
              if (null !== $this->permissions && $this->isColumnModified(sfGuardGroupModulePermissionPeer::PERMISSIONS)) {
				...
				$this->resetModified();
             $this->permissions = $o_permissions;
 // [HL] After being saved an object is no longer 'modified'
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(sfGuardGroupModulePermissionPeer::PERMISSIONS)) $criteria->add(sfGuardGroupModulePermissionPeer::PERMISSIONS, $this->permissions);
	...
	{
		if (self::$peer === null) {
			self::$peer = new sfGuardGroupModulePermissionPeer();
		}
		return self::$peer;
	}
