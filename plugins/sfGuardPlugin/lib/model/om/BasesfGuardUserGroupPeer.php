...
abstract class BasesfGuardUserGroupPeer {
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		if (stEventDispatcher::getInstance()->getListeners('sfGuardUserGroupPeer.postAddSelectColumns')) {
			stEventDispatcher::getInstance()->notify(new sfEvent($criteria, 'sfGuardUserGroupPeer.postAddSelectColumns'));
		}
	}
	...
	public static function doSelectJoinsfGuardUser(Criteria $c, $con = null)
	{
		...
		$rs = sfGuardUserGroupPeer::doSelectRs($c, $con);
