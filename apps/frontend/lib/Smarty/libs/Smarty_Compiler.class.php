...
/* $Id: Smarty_Compiler.class.php 127 2009-08-26 14:24:02Z marcin $ */
...
class Smarty_Compiler extends Smarty {
    ...
    function _compile_file($resource_name, $source_content, &$compiled_content)
    {
        ...
        $source_content = preg_replace_callback($search, function($matches) use ($compiler) {
            return $this->_quote_replace($compiler->left_delimiter) . 'php'
                                       
                                       . $compiler->_quote_replace($compiler->right_delimiter);
            }
            , $source_content);        
