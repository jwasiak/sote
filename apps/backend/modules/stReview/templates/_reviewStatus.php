...
<?php else: ?>  
    ...
    <?php if(!$order_product->getProduct()): ?>
        ...
        <img class="img_send<?php echo $order_product->getId() ?>" src="/images/backend/no_black.png" width="16" />
