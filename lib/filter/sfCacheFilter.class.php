 ...
 * @version    SVN: $Id: sfCacheFilter.class.php 7432 2010-08-10 09:51:54Z marcin $
 */
class sfCacheFilter extends sfFilter
{
  ...
  public function execute($filterChain)
  {
    ...
    // FC SOTE
    // @author      Marek Jakubowicz <marek.jakubowicz@sote.pl> 2010-06-27
    // if (! sfConfig::get('sf_cache') || count($_GET) || count($_POST)) 
    if ((! sfConfig::get('sf_cache') || count($_GET) && !isset($_GET['module']) && !isset($_GET['action']) || count($_POST)) && !isset($_POST['hash']) && !isset($_GET['hash']))
    {
        $filterChain->execute();
        return;
    }
