...
/**
 * Base class that represents a row from the 'st_order_status_coupon_code' table.
 *
 * 
 *
...
abstract class BaseOrderStatusCouponCode extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the valid_for field.
	 * @var        int
	 */
	protected $valid_for = 0;

	/**
	 * Collection to store aggregation of collOrderStatuss.
	 * @var        array
	 */
	protected $collOrderStatuss;

	/**
	 * The criteria used to select the current contents of collOrderStatuss.
	 * @var        Criteria
	 */
    ...
    /**
     * Get the [valid_for] column value.
     * 
     * @return     int
     */
	...
	/**
	 * Set the value of [valid_for] column.
	 * 
	 * @param      int $v new value
	 * @return     void
	 */
  ...
  {
    try {
      if ($this->getDispatcher()->getListeners('OrderStatusCouponCode.preHydrate')) {
          $event = $this->getDispatcher()->notify(new sfEvent($this, 'OrderStatusCouponCode.preHydrate', array('resultset' => $rs, 'startcol' => $startcol)));
      ...
      $this->discount = $rs->getString($startcol + 3);
      ...
      $this->setNew(false);
      if ($this->getDispatcher()->getListeners('OrderStatusCouponCode.postHydrate')) {
          $event = $this->getDispatcher()->notify(new sfEvent($this, 'OrderStatusCouponCode.postHydrate', array('resultset' => $rs, 'startcol' => $startcol + 5)));
          return $event['startcol'];
      }

      // FIXME - using NUM_COLUMNS may be clearer.
      return $startcol + 5; // 5 = OrderStatusCouponCodePeer::NUM_COLUMNS - OrderStatusCouponCodePeer::NUM_LAZY_LOAD_COLUMNS).
  ...
  public function delete($con = null)
  {
    ...
    if ($this->getDispatcher()->getListeners('OrderStatusCouponCode.preDelete')) {
        $this->getDispatcher()->notify(new sfEvent($this, 'OrderStatusCouponCode.preDelete', array('con' => $con)));
    }

    if (sfMixer::hasCallables('BaseOrderStatusCouponCode:delete:pre'))
    {
    ...
    if ($this->getDispatcher()->getListeners('OrderStatusCouponCode.postDelete')) {
        $this->getDispatcher()->notify(new sfEvent($this, 'OrderStatusCouponCode.postDelete', array('con' => $con)));
    }

    if (sfMixer::hasCallables('BaseOrderStatusCouponCode:delete:post'))
    {
  ...
  public function save($con = null)
  {
    ...
    if (!$this->alreadyInSave) {
      if ($this->getDispatcher()->getListeners('OrderStatusCouponCode.preSave')) {
    ...
    try {
      ...
      if (!$this->alreadyInSave) {
        if ($this->getDispatcher()->getListeners('OrderStatusCouponCode.postSave')) {
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of OrderStatusCouponCode (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     OrderStatusCouponCode Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     OrderStatusCouponCodePeer
	 */
	...
	/**
	 * Temporary storage of collOrderStatuss to save a possible db hit in
	 ...
	 * Otherwise if this OrderStatusCouponCode has previously
	 * been saved, it will retrieve related OrderStatuss from storage.
	 * If this OrderStatusCouponCode is new, it will return
	...
	/**
	 * Returns the number of related OrderStatuss.
	 *
	 * @param      Criteria $criteria
	...
	/**
	 * Method called to associate a OrderStatus object to this object
	 * through the OrderStatus foreign key attribute
	 *
	 * @param      OrderStatus $l OrderStatus
	 * @return     void
	 * @throws     PropelException
	 */
