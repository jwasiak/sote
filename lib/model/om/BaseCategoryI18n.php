...
/**
 * Base class that represents a row from the 'st_category_i18n' table.
 *
 * 
 *
...
abstract class BaseCategoryI18n extends BaseObject  implements Persistent {
  ...
  {
    try {
      if ($this->getDispatcher()->getListeners('CategoryI18n.preHydrate')) {
          $event = $this->getDispatcher()->notify(new sfEvent($this, 'CategoryI18n.preHydrate', array('resultset' => $rs, 'startcol' => $startcol)));
      ...
      $this->setNew(false);
      if ($this->getDispatcher()->getListeners('CategoryI18n.postHydrate')) {
          $event = $this->getDispatcher()->notify(new sfEvent($this, 'CategoryI18n.postHydrate', array('resultset' => $rs, 'startcol' => $startcol + 5)));
          return $event['startcol'];
      }

      // FIXME - using NUM_COLUMNS may be clearer.
      return $startcol + 5; // 5 = CategoryI18nPeer::NUM_COLUMNS - CategoryI18nPeer::NUM_LAZY_LOAD_COLUMNS).
  ...
  public function delete($con = null)
  {
    ...
    if ($this->getDispatcher()->getListeners('CategoryI18n.preDelete')) {
        $this->getDispatcher()->notify(new sfEvent($this, 'CategoryI18n.preDelete', array('con' => $con)));
    }

    if (sfMixer::hasCallables('BaseCategoryI18n:delete:pre'))
    {
    ...
    if ($this->getDispatcher()->getListeners('CategoryI18n.postDelete')) {
        $this->getDispatcher()->notify(new sfEvent($this, 'CategoryI18n.postDelete', array('con' => $con)));
    }

    if (sfMixer::hasCallables('BaseCategoryI18n:delete:post'))
    {
  ...
  public function save($con = null)
  {
    ...
    if (!$this->alreadyInSave) {
      if ($this->getDispatcher()->getListeners('CategoryI18n.preSave')) {
    ...
    try {
      ...
      if (!$this->alreadyInSave) {
        if ($this->getDispatcher()->getListeners('CategoryI18n.postSave')) {
