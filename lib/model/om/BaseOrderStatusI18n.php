...
/**
 * Base class that represents a row from the 'st_order_status_i18n' table.
 *
 * 
 *
...
abstract class BaseOrderStatusI18n extends BaseObject  implements Persistent {
	...
	public function setName($v)
	{
        ...
        if ($this->name !== $v) {
          $this->name = $v;
          $this->modifiedColumns[] = OrderStatusI18nPeer::NAME;
        }
  ...
  {
    try {
      if ($this->getDispatcher()->getListeners('OrderStatusI18n.preHydrate')) {
          $event = $this->getDispatcher()->notify(new sfEvent($this, 'OrderStatusI18n.preHydrate', array('resultset' => $rs, 'startcol' => $startcol)));
      ...
      $this->setNew(false);
      if ($this->getDispatcher()->getListeners('OrderStatusI18n.postHydrate')) {
          $event = $this->getDispatcher()->notify(new sfEvent($this, 'OrderStatusI18n.postHydrate', array('resultset' => $rs, 'startcol' => $startcol + 4)));
          return $event['startcol'];
      }

      // FIXME - using NUM_COLUMNS may be clearer.
      return $startcol + 4; // 4 = OrderStatusI18nPeer::NUM_COLUMNS - OrderStatusI18nPeer::NUM_LAZY_LOAD_COLUMNS).
  ...
  public function delete($con = null)
  {
    ...
    if ($this->getDispatcher()->getListeners('OrderStatusI18n.preDelete')) {
        $this->getDispatcher()->notify(new sfEvent($this, 'OrderStatusI18n.preDelete', array('con' => $con)));
    }

    if (sfMixer::hasCallables('BaseOrderStatusI18n:delete:pre'))
    {
    ...
    if ($this->getDispatcher()->getListeners('OrderStatusI18n.postDelete')) {
        $this->getDispatcher()->notify(new sfEvent($this, 'OrderStatusI18n.postDelete', array('con' => $con)));
    }

    if (sfMixer::hasCallables('BaseOrderStatusI18n:delete:post'))
    {
  ...
  public function save($con = null)
  {
    ...
    if (!$this->alreadyInSave) {
      if ($this->getDispatcher()->getListeners('OrderStatusI18n.preSave')) {
          $this->getDispatcher()->notify(new sfEvent($this, 'OrderStatusI18n.preSave', array('con' => $con)));
      }
    ...
    try {
      ...
      if (!$this->alreadyInSave) {
        if ($this->getDispatcher()->getListeners('OrderStatusI18n.postSave')) {
            $this->getDispatcher()->notify(new sfEvent($this, 'OrderStatusI18n.postSave', array('con' => $con)));
        }
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(OrderStatusI18nPeer::NAME)) $criteria->add(OrderStatusI18nPeer::NAME, $this->name);
	...
	public function getOrderStatus($con = null)
	{
		if ($this->aOrderStatus === null && ($this->id !== null)) {
			...
			/* The following can be used instead of the line above to
			   ...
			   never be used.
			   $obj = OrderStatusPeer::retrieveByPK($this->id, $con);
  ...
  {
      $event = $this->getDispatcher()->notifyUntil(new sfEvent($this, 'OrderStatusI18n.' . $method, array('arguments' => $arguments, 'method' => $method)));
