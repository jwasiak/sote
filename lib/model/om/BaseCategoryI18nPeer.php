...
/**
 * Base static class for performing query and update operations on the 'st_category_i18n' table.
 *
 * 
 *
...
abstract class BaseCategoryI18nPeer {
	...
	const TABLE_NAME = 'st_category_i18n';
	...
	const ID = 'st_category_i18n.ID';

	/** the column name for the CULTURE field */
	const CULTURE = 'st_category_i18n.CULTURE';

	/** the column name for the NAME field */
	const NAME = 'st_category_i18n.NAME';

	/** the column name for the URL field */
	const URL = 'st_category_i18n.URL';

	/** the column name for the DESCRIPTION field */
	const DESCRIPTION = 'st_category_i18n.DESCRIPTION';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (CategoryI18nPeer::ID, CategoryI18nPeer::CULTURE, CategoryI18nPeer::NAME, CategoryI18nPeer::URL, CategoryI18nPeer::DESCRIPTION, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (CategoryI18nPeer::ID => 0, CategoryI18nPeer::CULTURE => 1, CategoryI18nPeer::NAME => 2, CategoryI18nPeer::URL => 3, CategoryI18nPeer::DESCRIPTION => 4, ),
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CategoryI18nPeer::URL);

		$criteria->addSelectColumn(CategoryI18nPeer::DESCRIPTION);


		if (stEventDispatcher::getInstance()->getListeners('CategoryI18nPeer.postAddSelectColumns')) {
			stEventDispatcher::getInstance()->notify(new sfEvent($criteria, 'CategoryI18nPeer.postAddSelectColumns'));
		}
	}

	const COUNT = 'COUNT(st_category_i18n.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT st_category_i18n.ID)';
	...
	public static function doSelectJoinCategory(Criteria $c, $con = null)
	{
		...
		$rs = CategoryI18nPeer::doSelectRs($c, $con);
	...
	/**
	 * Method to DELETE all rows from the st_category_i18n table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
