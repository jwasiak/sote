...
/**
 * This class adds structure of 'st_order_user_data_delivery' table to 'propel' DatabaseMap object.
 *
 *
 *
 ...
 */
class OrderUserDataDeliveryMapBuilder {

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lib.model.map.OrderUserDataDeliveryMapBuilder';
    ...
    public function doBuild()
    {
        ...
        $tMap = $this->dbMap->addTable('st_order_user_data_delivery');
        $tMap->setPhpName('OrderUserDataDelivery');
...
} // OrderUserDataDeliveryMapBuilder
