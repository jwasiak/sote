...
/**
 * This class adds structure of 'st_review_order' table to 'propel' DatabaseMap object.
 *
 *
 *
 ...
 */
class ReviewOrderMapBuilder {

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lib.model.map.ReviewOrderMapBuilder';
    ...
    public function doBuild()
    {
        ...
        $tMap = $this->dbMap->addTable('st_review_order');
        $tMap->setPhpName('ReviewOrder');
        ...
        $tMap->addColumn('MARK', 'Mark', 'int', CreoleTypes::INTEGER, false, null);
