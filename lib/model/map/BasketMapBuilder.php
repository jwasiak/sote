...
/**
 * This class adds structure of 'st_basket' table to 'propel' DatabaseMap object.
 *
 *
 *
...
class BasketMapBuilder {
     ...
     */
    const CLASS_NAME = 'lib.model.map.BasketMapBuilder';
    ...
    public function doBuild()
    {
        ...
        $tMap = $this->dbMap->addTable('st_basket');
        ...
        $tMap->addColumn('HASH_CODE', 'HashCode', 'string', CreoleTypes::VARCHAR, false, 32);
