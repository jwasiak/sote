...
/**
 * This class adds structure of 'st_product_group_i18n' table to 'propel' DatabaseMap object.
 *
 *
 *
...
class ProductGroupI18nMapBuilder {
    ...
    public function doBuild()
    {
        ...
        $tMap = $this->dbMap->addTable('st_product_group_i18n');
        $tMap->setPhpName('ProductGroupI18n');

        $tMap->setUseIdGenerator(false);

        $tMap->addForeignPrimaryKey('ID', 'Id', 'int' , CreoleTypes::INTEGER, 'st_product_group', 'ID', true, null);
