...
/**
 * This class adds structure of 'st_user_data' table to 'propel' DatabaseMap object.
 *
 *
 *
 ...
 */
class UserDataMapBuilder {

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lib.model.map.UserDataMapBuilder';
    ...
    public function doBuild()
    {
        ...
        $tMap = $this->dbMap->addTable('st_user_data');
        $tMap->setPhpName('UserData');
        ...
        $tMap->addColumn('IS_BILLING', 'IsBilling', 'boolean', CreoleTypes::BOOLEAN, false, null);
        ...
        $tMap->addColumn('FULL_NAME', 'FullName', 'string', CreoleTypes::VARCHAR, false, 128);
        ...
        $tMap->addColumn('REGION', 'Region', 'string', CreoleTypes::VARCHAR, false, 128);
