 ...
 * @version    SVN: $Id: sfPropelData.class.php 10293 2011-01-18 11:52:39Z marek $
 */
class sfPropelData extends sfData
{
   ...
   */
  public function loadData($directory_or_file = null, $connectionName = 'propel', $fixtures_dir_name='fixtures')
  {
    $fixture_files = $this->getFiles($directory_or_file, $fixtures_dir_name);
