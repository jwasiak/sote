   ...
   public function execute($filterChain)
   {
      ...
      if (!$viewName)
      {
         ...
         else
         {
            ...
            if (class_exists('stEventDispatcher'))
            {
               stEventDispatcher::getInstance()->notify(new sfEvent($actionInstance, 'stActions.preValidate'));
            }
            ...
            if (class_exists('stEventDispatcher')) $validated = stEventDispatcher::getInstance()->filter(new sfEvent($actionInstance, get_class($actionInstance).'.'.$validateToRun), $validated)->getReturnValue();
