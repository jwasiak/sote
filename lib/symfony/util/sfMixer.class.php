...
class sfMixer
{
  ...
  static public function setMixins($mixins)
  {
    self::$mixins = $mixins;
  }

  static public function getMixinParameters()
  {
    return self::$mixinParameters;
  }

  static public function setMixinParameters($parameters)
  {
    self::$mixinParameters = $parameters;
  }

  static public function getMixinInstance($name)
  {
    if (!isset(self::$mixinInstancesPool[$name]) && isset(self::$mixins[$name]))
    {
      self::$mixinInstancesPool[$name] = true;
  ...
  static public function hasCallables($name)
  {
    return isset(self::$mixins[$name]);
  }
