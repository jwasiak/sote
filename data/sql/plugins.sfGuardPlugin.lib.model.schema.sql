...
(
	...
	`is_admin_confirm` INTEGER default 0,
	`hash_code` VARCHAR(128),
	`language` VARCHAR(10),
	`external_account` VARCHAR(128),
	`points` INTEGER default 0,
	`points_available` INTEGER default 1,
	`points_release` INTEGER default 0,
	`opt_allegro_user_id` INTEGER,
	`wholesale` CHAR(1) default '0' NOT NULL,
	PRIMARY KEY (`id`),
	UNIQUE KEY `sf_guard_user_username_unique` (`username`),
	KEY `opt_allegro_user_id_idx`(`opt_allegro_user_id`)
)Engine=MyISAM;
...
DROP TABLE IF EXISTS `sf_guard_user_module_permission`;


CREATE TABLE `sf_guard_user_module_permission`
(
	`id` INTEGER  NOT NULL,
	`permissions` TEXT,
	PRIMARY KEY (`id`),
	CONSTRAINT `sf_guard_user_module_permission_FK_1`
		FOREIGN KEY (`id`)
		REFERENCES `sf_guard_user` (`id`)
		ON DELETE CASCADE
)Engine=MyISAM;
...
DROP TABLE IF EXISTS `sf_guard_group_module_permission`;


CREATE TABLE `sf_guard_group_module_permission`
(
	`id` INTEGER  NOT NULL,
	`permissions` TEXT,
	PRIMARY KEY (`id`),
	CONSTRAINT `sf_guard_group_module_permission_FK_1`
		FOREIGN KEY (`id`)
		REFERENCES `sf_guard_group` (`id`)
		ON DELETE CASCADE
)Engine=MyISAM;
