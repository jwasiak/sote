...
if (!extension_loaded('mysql') && !function_exists('mysql_connect')) {
	 ...
	 * @return mysqli|null
	 */
	function _getLinkIdentifier(mysqli $mysqli = null)
	{
		global $link;
	 ...
	 * @param mysqli $mysqli
	 */
	function _setLinkIdentifier(mysqli $mysqli)
	{
		global $link;
	...
	{
		return _getLinkIdentifier($mysqli)->query($query);
	}
	...
	{
		return _getLinkIdentifier($mysqli)->escape_string($string);
	}
	...
	{
		return mysqli_affected_rows(_getLinkIdentifier($mysqli));
	}
	...
	{
		return mysqli_character_set_name(_getLinkIdentifier($mysqli));
	}
	...
	{
		return mysqli_close(_getLinkIdentifier($mysqli));
	}
	...
	{
		return mysqli_errno(_getLinkIdentifier($mysqli));
	}
	...
	{
		return mysqli_error(_getLinkIdentifier($mysqli));
	}
	...
	{
		return mysqli_ping(_getLinkIdentifier($mysqli));
	}
	...
	{
		return mysqli_query(_getLinkIdentifier($mysqli), $query, MYSQLI_USE_RESULT);
	}
	...
	function mysql_list_dbs(mysqli $mysqli = null)
	{
		...
		return mysqli_query(_getLinkIdentifier($mysqli), 'SHOW DATABASES');
	}
	...
	function mysql_list_fields($database_name, $table_name, mysqli $mysqli = null)
	{
		...
		$mysqli = _getLinkIdentifier($mysqli);
	...
	{
		return mysqli_query(_getLinkIdentifier($mysqli), 'SHOW PROCESSLIST');
	}
	...
	{
		return mysqli_set_charset(_getLinkIdentifier($mysqli), $charset);
	}
	...
	{
		$result = mysqli_info(_getLinkIdentifier($mysqli));
		if ($result === NULL) {
			$result = false;
		}
	...
	{
		return mysqli_stat(_getLinkIdentifier($mysqli));
	}
	...
	{
		return mysqli_thread_id(_getLinkIdentifier($mysqli));
	}
	...
	{
		return mysqli_get_host_info(_getLinkIdentifier($mysqli));
	}
	...
	{
		return mysqli_get_proto_info(_getLinkIdentifier($mysqli));
	}
	...
	{
		return mysqli_get_server_info(_getLinkIdentifier($mysqli));
	}
	...
	{
		return mysqli_insert_id(_getLinkIdentifier($mysqli));
	}
